...
class RestaurantData:
    ...
    def ReturnRestaurantName(self, currentCity, currentLocality):
        ...
        DataFieldWholeTemp = self.DataFieldWhole[(self.DataFieldWhole['City'] == self.selectedCityName) & (
                    self.DataFieldWhole['Locality'] == self.selectedLocalityName)]
    ...
    def ReturnDF(self):
        ...
        self.data_new_delphi['Locality'].value_counts(dropna=False)
    ...
    def ReturnTopFiveRestaurantName(self):
        ...
        restaurantTopFive = restaurantTopFive[
            ['City', 'Locality', 'Restaurant Name', 'Aggregate rating', 'Weighted Aggregate Rating']].head(5)
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMouseTracking(False) #redundant
        MainWindow.setAutoFillBackground(False)             # redundant
        MainWindow.setStyleSheet("background-color: rgb(243, 243, 243);")
        self.drawFrontPage()

    def drawFrontPage(self):
        self.centralwidget = QtWidgets.QWidget(MainWindow)    # for first page
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget)     # for equal spacing between top restaurants.
        ...
        self.lineSeparator = QtWidgets.QFrame(self.frame)                # for horizonatal rule, just for better layout
    ...
    def retranslateUi(self, MainWindow):                # execution of front page
        ...
        self.cBCity.addItems(self.Data.ReturnCityName())                             # IMPORTANT
        ...
        self.cBRestaurant.addItems(
            self.Data.ReturnRestaurantName(self.cBCity.currentText(), (self.cBlocality.currentText())))

        self.bSearch.clicked.connect(self.ShowResults)

        self.LTopRestaurants.setText(_translate("MainWindow",
                                                "<html><head/><body><p><span style=\" font-size:20pt; color:#1b1b1b;\">Top </span><span style=\" font-size:20pt; color:#55aa00;\">Indian Restaurants</span></p></body></html>"))

        self.LRestaurantStar1.setText(
            _translate("MainWindow", str(self.Data.tempTopRestaurantDF['Aggregate rating'].iloc[0])))
        self.LRestaurantStar2.setText(
            _translate("MainWindow", str(self.Data.tempTopRestaurantDF['Aggregate rating'].iloc[1])))
        self.LRestaurantStar3.setText(
            _translate("MainWindow", str(self.Data.tempTopRestaurantDF['Aggregate rating'].iloc[2])))
        self.LRestaurantStar4.setText(
            _translate("MainWindow", str(self.Data.tempTopRestaurantDF['Aggregate rating'].iloc[3])))
        self.LRestaurantStar5.setText(
            _translate("MainWindow", str(self.Data.tempTopRestaurantDF['Aggregate rating'].iloc[4])))
    ...
    def CheckValues(self):
        ...
        if (self.Data.selectedCityName == 'City' or self.Data.selectedCityName == '' \
            ...
            x = msgbox.exec_()
        elif (self.Data.selectedRestaurantName not in self.Data.ReturnRestaurantName(self.cBCity.currentText(),
                                                                                     self.cBlocality.currentText())):
    ...
    def retranslateNextUi(self, centralWidget2):
        ...
        self.label.setText(_translate("centralWidget2",
                                      "<html><head/><body><p align=\"center\"><span style=\" font-size:24pt; font-weight:600; color:#ffffff;\">Restaurants </span><span style=\" font-size:24pt; font-weight:600; color:#55aa00;\">We Recommend</span></p><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; color:#ffffff;\">Based on </span><span style=\" font-size:16pt; font-weight:600; color:#55aa00;\">Your choice</span></p></body></html>"))

        self.LCityName.setText(_translate("centralWidget2",
                                          "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">City Name :</span></p></body></html>"))

        self.LCityNameEnter.setText(_translate("centralWidget2",
                                               "<html><head/><body><p><span style=\" font-size:10pt;\">{}</span></p></body></html>".format(
                                                   self.Data.selectedCityName)))

        self.LLocalityName.setText(_translate("centralWidget2",
                                              "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Locality Name :</span></p></body></html>"))

        self.LLocaltyNameEnter.setText(_translate("centralWidget2",
                                                  "<html><head/><body><p><span style=\" font-size:10pt;\">{}</span></p></body></html>".format(
                                                      self.Data.selectedLocalityName)))

        self.LRestaurantName.setText(_translate("centralWidget2",
                                                "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Restaurant Name :</span></p></body></html>"))

        self.LRestaurantNameEnter.setText(_translate("centralWidget2",
                                                     "<html><head/><body><p><span style=\" font-size:10pt;\">{}</span></p></body></html>".format(
                                                         self.Data.selectedRestaurantName)))
        ...
        if (self.Data.ReturnDF().empty == True):
            ...
            msgbox.setText(
                "Sorry, no recommendation available for {}, Right Now!".format(self.Data.selectedRestaurantName))
...
if __name__ == "__main__":
    ...
    app = QtWidgets.QApplication(sys.argv)      # creates main windows
    MainWindow = QtWidgets.QMainWindow()    # implementation of main window.
    ui = Ui_MainWindow()     # object of UI class
    ui.setupUi(MainWindow)    # method of UI_Mainwindowc class
    MainWindow.show()          # execution of display part
    sys.exit(app.exec_())       # return statement for exit, helps in execution